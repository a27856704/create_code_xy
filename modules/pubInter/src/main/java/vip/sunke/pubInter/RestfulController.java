...
public abstract class RestfulController<
    ...
    @ResponseBody
    public SkJsonResult<DataVO> getDetail(@PathVariable String id, HttpServletRequest request, HttpSession session) throws SkException {
    ...
    @ResponseBody
    public SkJsonResult<DataVO> postMod(@PathVariable String id, @Valid DTO dto, Model model, HttpServletRequest request, HttpSession session) throws SkException {
    ...
    @ResponseBody
    public SkJsonResult postDeleteAll(@RequestParam(name = "ids[]") List<String> ids, Model model, HttpServletRequest request, HttpSession session) throws SkException {
